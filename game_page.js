...
document.getElementById("scor").innerHTML=player_score;
document.getElementById("sccore").innerHTML=player1_score;
function send(){
...
function check(){
  ...
  if(get_answer == actual_answer){
      if(answer_turn=="player1"){
          ...
          document.getElementById("player1_name").innerHTML=player_score;
      }
      else{
        player1_score= player1_score+1;
        document.getElementById("player2_name").innerHTML=player1_score;
    }
